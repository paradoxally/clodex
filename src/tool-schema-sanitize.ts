...
//     routes and OpenCode Go's Responses model, and `@ai-sdk/openai-compatible`
//     goes to Chat Completions, which is non-strict by default. The explicit opt-out is load-bearing for
